...
public class LoginStepDefsTest {
    ...
    public void meLogeoExitosamente() throws Throwable {
        assertTrue(this.loginService.login(this.usuario.getUsuario(), this.usuario.getContrasena()));
    ...
    public void elUsuarioNoPudoLogearse() throws Throwable {
        try {
            this.loginService.login(this.usuario.getUsuario(), this.usuario.getContrasena());
        } catch (Exception e) { }
    ...
    public void ingresoMiUsuarioMiContraseñaMiNombreYMiApellido(String user, String password, String nombre, String apellido) throws Throwable {
        ...
        this.usuarioNuevo.setContrasena(password);
